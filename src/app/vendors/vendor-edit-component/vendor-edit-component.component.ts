...
@Component({
  selector: 'app-vendor-edit-component',
  templateUrl: './vendor-edit-component.component.html',
  styleUrls: ['./vendor-edit-component.component.scss']
})
export class VendorEditComponentComponent implements OnInit {
