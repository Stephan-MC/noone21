...
@Component({
  selector: 'app-normal-template',
  templateUrl: './normal-template.component.html',
  styleUrls: ['./normal-template.component.scss']
})
export class NormalTemplateComponent implements OnInit {
slug:string;
pageContent:any;
  ...
  getpages() {
    this.requestService.sendRequest('admin/dynamicPage/get', 'GET', {page_type:1,page_slug:this.slug}).subscribe(res => {
      if (res && res.status) {
