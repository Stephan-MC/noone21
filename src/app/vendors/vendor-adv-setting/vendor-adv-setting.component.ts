...
@Component({
  selector: 'app-vendor-adv-setting',
  templateUrl: './vendor-adv-setting.component.html',
  styleUrls: ['./vendor-adv-setting.component.scss']
})
export class VendorAdvSettingComponent implements OnInit {
