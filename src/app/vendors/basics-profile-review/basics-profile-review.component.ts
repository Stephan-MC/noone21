...
@Component({
  selector: 'app-basics-profile-review',
  templateUrl: './basics-profile-review.component.html',
  styleUrls: ['./basics-profile-review.component.scss']
})
export class BasicsProfileReviewComponent implements OnInit {
