...
@Component({
  selector: 'app-doctor-condition-treated',
  templateUrl: './doctor-condition-treated.component.html',
  styleUrls: ['./doctor-condition-treated.component.scss']
})
export class DoctorConditionTreatedComponent implements OnInit {
